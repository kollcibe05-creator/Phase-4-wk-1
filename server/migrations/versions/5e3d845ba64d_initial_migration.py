...
Revision ID: 5e3d845ba64d
Revises: 
Create Date: 2026-01-08 01:40:55.285309
...
def upgrade():
    ...
    sa.CheckConstraint('length(description) >= 20', name='minimum_length'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.CheckConstraint("strength IN ('Strong', 'Weak', 'Average')", name='valid_level_of_strength'),
